...
Snapshot 20260812153044: 42 dirs, 318 files (0 unchanged, 0 failed), 0 links skipped, 0 dirs and 0 files excluded
```
...
printed (`20260812153044` here) is a real timestamp-derived id you can
refer to later with `SNAPID=`.
...
AmiSnap 0.1 (12.08.2026)
Snapshot 20260813091200: 42 dirs, 318 files (316 unchanged, 0 failed), 0 links skipped, 0 dirs and 0 files excluded
```
...
AmiSnap 0.1 (12.08.2026)
20260812153044  42 dirs  318 files  "first backup"
20260813091200  42 dirs  318 files  "second backup"
```
...
AmiSnap 0.1 (12.08.2026)
Verify 20260813091200 (structural): 318 objects checked, 0 missing, 0 corrupt
```
...
AmiSnap 0.1 (12.08.2026)
Restore 20260813091200: 42 dirs, 318 files, 0 links skipped
```
