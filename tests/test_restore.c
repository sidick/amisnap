...
void run_restore_tests(void)
{
    ...
    /* --- Full restore --- */
    TEST_CHECK(amisnap_restore_manifest(&repo, &dest, NULL, AMISNAP_OBJCOMP_RAW, NULL, mf.data, mf.len, NULL, &result) == AMISNAP_OK);
     ...
     * record_entry_restored's own comment above for why this matters. --- */
    {
        ...
        TEST_CHECK(amisnap_restore_manifest(&repo, &dest6, NULL, AMISNAP_OBJCOMP_RAW, NULL, mf.data, mf.len, &opts6, &r6) == AMISNAP_OK);
    ...
    /* --- Subtree restore: only "Sub" and its contents --- */
    {
        ...
        TEST_CHECK(amisnap_restore_manifest(&repo, &dest2, NULL, AMISNAP_OBJCOMP_RAW, NULL, mf.data, mf.len, &opts, &r2) == AMISNAP_OK);
         ...
         * component-boundary correctness. */
        {
            ...
            TEST_CHECK(amisnap_restore_manifest(&repo, &dest3, NULL, AMISNAP_OBJCOMP_RAW, NULL, mf.data, mf.len, &opts3, &r3) == AMISNAP_OK);
     ...
     * tree with no indication anything went wrong). --- */
    {
        ...
        TEST_CHECK(amisnap_restore_manifest(&repo, &dest4, NULL, AMISNAP_OBJCOMP_RAW, NULL, mf.data, mf.len, NULL, &r4) == AMISNAP_ERR_NOT_FOUND);
     ...
     * aborts with AMISNAP_ERR_HASH_MISMATCH, never gets written out. --- */
    {
        ...
        TEST_CHECK(amisnap_restore_manifest(&repo, &dest5, NULL, AMISNAP_OBJCOMP_RAW, NULL, mf.data, mf.len, NULL, &r5) == AMISNAP_ERR_HASH_MISMATCH);
